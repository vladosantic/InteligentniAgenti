breed [rovers rover]
breed [aliens alien]
globals [ roverList roverCounter alienList alienCounter x y]
...
to rover1
  ask rover 0[
    ...
    [
      if not (member? "Orange" roverList )
      [
        set roverList lput "Orange" roverList
        set roverCounter roverCounter + 1
        show roverList
      ]
    ]
    if ([pcolor] of patch-here = red)
    [
      if not (member? "Red" roverList )
      [
        set roverList lput "Red" roverList
        set roverCounter roverCounter + 1
        show roverList
      ]
    ]
    ...
    [
      if not (member? "Blue" roverList )
      [
        set roverList lput "Blue" roverList
        set roverCounter roverCounter + 1
        show roverList
      ]
    ]
...
to aliens1
  ask aliens[
    ...
    let random-y random-pycor
    move-to patch random-x random-y
    if ([pcolor] of patch-here = orange)
    [
      if not (member? "Orange" alienList )
      [
        set alienList lput "Orange" alienList
        set alienCounter alienCounter + 1
        show alienList
      ]
    ]
    if ([pcolor] of patch-here = red)
    [
      if not (member? "Red" roverList )
      [
        set alienList lput "Red" alienList
        set alienCounter alienCounter + 1
        show alienList
      ]
    ]
    if ([pcolor] of patch-here = blue)
    [
      if not (member? "Blue" alienList )
      [
        set alienList lput "Blue" alienList
        set alienCounter alienCounter + 1
        show alienList
      ]
    ]
