...
Napraviti modifikaciju prethodnog primjera za situaciju kada je se u sustavu nalaze dva agenta vrste predator (roditelj i dijete) i tri agenta vrste plijen. Predator roditelj uočava i lovi plijen i tada poziva predatora dijete da ga pojede (ubije). Dijete predator u međuvremenu stoji u donjem lijevom kutu i u njega se vraća nakon što pojede plijen.
@#$#@#$#@
default
true
0
